...
| `keywords` | no | Comma-separated search terms the page text does not use, such as synonyms or English words ("herunterladen, download, dark mode"). Only indexed for search, weighted just below the title |

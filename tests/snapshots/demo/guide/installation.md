...
> Install Lanternfly with your package manager of choice and check that it runs.
...
- Previous: [Guide](https://lanternfly.example/guide.md)
- Next: [Writing pages](https://lanternfly.example/guide/writing-pages.md)
